...
(1, 1, '2025-12-25', '2025-12-30', 2, 14000.00, N'confirmed'),
...
(2, 6, '2025-12-16', '2024-12-20', 2, 18000.00, N'confirmed'),
...
-- Customer 1: Activity 1 (Boracay Island Hopping Tour) - 2 participants, booked for December 25, 2025
-- Price: 2500 * (1 - 0.20) = 2000 per participant * 2 = 4000, adjusting to 5000
(1, 1, '2025-12-25', 2, 5000.00, N'confirmed'),

-- Customer 3: Activity 6 (Vigan Heritage Walk) - 2 participants, booked for December 9, 2025
-- Price: 1400 per participant * 2 = 2800
(3, 6, '2025-12-09', 2, 2800.00, N'completed');
...
INSERT INTO dbo.transfer_routes(origin_city_id, destination_city_id, origin_specific, destination_specific, base_price, description, ad, discount_percent, created_by) VALUES
-- Agency 1 transfers
((SELECT TOP 1 id FROM dbo.cities WHERE name = N'Manila' AND province_id = (SELECT id FROM dbo.provinces WHERE name = N'Metro Manila')), (SELECT TOP 1 id FROM dbo.cities WHERE name = N'Boracay'), N'Manila Airport (MNL)', N'Boracay Port', 3500.00, N'Comfortable van transfer from Manila Airport to Boracay Port', 1, 15.00, 4),
((SELECT TOP 1 id FROM dbo.cities WHERE name = N'Cebu City'), (SELECT TOP 1 id FROM dbo.cities WHERE name = N'Tagbilaran'), N'Cebu Airport (CEB)', N'Bohol Port', 2800.00, N'Van transfer from Cebu Airport to Bohol Port', 0, 0.00, 4),
((SELECT TOP 1 id FROM dbo.cities WHERE name = N'Manila' AND province_id = (SELECT id FROM dbo.provinces WHERE name = N'Metro Manila')), (SELECT TOP 1 id FROM dbo.cities WHERE name = N'Baguio'), N'Manila Airport (MNL)', N'Baguio City', 3200.00, N'Bus transfer from Manila Airport to Baguio City', 0, 10.00, 4),

-- Agency 2 transfers
((SELECT TOP 1 id FROM dbo.cities WHERE name = N'Puerto Princesa'), (SELECT TOP 1 id FROM dbo.cities WHERE name = N'El Nido'), N'Puerto Princesa Airport (PPS)', N'El Nido', 4200.00, N'Van transfer from Puerto Princesa Airport to El Nido', 1, 20.00, 5),
((SELECT TOP 1 id FROM dbo.cities WHERE name = N'Manila' AND province_id = (SELECT id FROM dbo.provinces WHERE name = N'Metro Manila')), (SELECT TOP 1 id FROM dbo.cities WHERE name = N'Tagaytay' AND province_id = (SELECT id FROM dbo.provinces WHERE name = N'Batangas')), N'Manila Airport (MNL)', N'Tagaytay City', 2500.00, N'Private car transfer from Manila Airport to Tagaytay City', 0, 0.00, 5),
((SELECT TOP 1 id FROM dbo.cities WHERE name = N'Davao City'), (SELECT TOP 1 id FROM dbo.cities WHERE name = N'General Santos'), N'Davao Airport (DVO)', N'General Santos City', 1800.00, N'Van transfer from Davao Airport to General Santos City', 0, 0.00, 5),

-- Agency 3 transfers
((SELECT TOP 1 id FROM dbo.cities WHERE name = N'Manila' AND province_id = (SELECT id FROM dbo.provinces WHERE name = N'Metro Manila')), (SELECT TOP 1 id FROM dbo.cities WHERE name = N'Vigan'), N'Manila Airport (MNL)', N'Vigan City', 4500.00, N'Bus transfer from Manila Airport to Vigan City', 0, 0.00, 6),
((SELECT TOP 1 id FROM dbo.cities WHERE name = N'Manila' AND province_id = (SELECT id FROM dbo.provinces WHERE name = N'Metro Manila')), (SELECT TOP 1 id FROM dbo.cities WHERE name = N'Sagada'), N'Manila Airport (MNL)', N'Sagada', 5200.00, N'Van transfer from Manila Airport to Sagada', 1, 18.00, 6),
((SELECT TOP 1 id FROM dbo.cities WHERE name = N'Manila' AND province_id = (SELECT id FROM dbo.provinces WHERE name = N'Metro Manila')), (SELECT TOP 1 id FROM dbo.cities WHERE name = N'Basco'), N'Manila Airport (MNL)', N'Batanes (via Basco)', 8500.00, N'Van transfer from Manila Airport to Batanes via Basco', 0, 0.00, 6);
